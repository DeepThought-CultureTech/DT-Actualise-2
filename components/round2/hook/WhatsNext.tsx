...
function Card({
  ...
  return (
    <div className="bg-white rounded-xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-all text-left">
  <div className="bg-blue-100 p-3 sm:p-4 rounded-xl w-fit mb-4 sm:mb-6">
    {icon}
  </div>
